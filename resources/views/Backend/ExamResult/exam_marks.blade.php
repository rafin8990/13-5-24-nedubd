            ...
            <div class=" mb-3">
                <div class="card-body p-2">
                    <div class="grid grid-cols-11 gap-4">
                        ...
                        <div class="col-span-1">
                            <div class="">
                                <button type="submit" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mt-5" >Find</button>
                            </div>
                        </div>
                        <div class="col-span-3">
                            <div class="">
                                ...
                                <br>
                                <button class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mt-3" >Upload</button>
                            </div>
                        </div>
...
<div class="mt-5">
    ...
    <div class="w-full ">
        ...
        <form id="generateExcelForm" action="{{route('generateExcel',$school_code)}}">
            @csrf
