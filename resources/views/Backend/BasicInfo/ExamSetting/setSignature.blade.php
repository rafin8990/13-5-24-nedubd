    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 md:my-10">
        <form action="">
            <div class="md:flex my-10 ">
                ...
                <div>
                    <button type="button" id="getDataButton"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">GET
                        DATA
                    </button>
                </div>
        ...
        <div class="text-lg font-bold" id="dataTable" style="display: none;">
            <div class="flex justify-center">
                <h3>
                    REPORT NAME WISE SIGNATURE SETTING
                </h3>
        ...
        <div class="md:flex justify-center">
            ...
            <div class="mr-10"> 
             <button type="submit"
                        class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Close
                </button>
            </div>
...
<script>
    $(document).ready(function() {
        $('#getDataButton').click(function() {
            let selectedReport = $('#countries').val();
            if (selectedReport === "Choose Report") {
            ...
            $.each(data, function(index, value) {
                let row = '<tr>' +
                    ...
                    '<td class="px-6 py-4">Position ' + (index + 1) + '</td>' +
