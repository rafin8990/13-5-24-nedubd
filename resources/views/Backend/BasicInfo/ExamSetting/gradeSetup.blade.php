...
<div class="md:flex justify-center">
    <div class="mr-10">
        <button type="submit"
        class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">GET Config View</button>
    </div>
    <div class="mr-10">
        <button type="submit"
    ...
    <div class="ml-32">
        <h3>Total = <div class="border border-2"></div></h3>
    </div>
