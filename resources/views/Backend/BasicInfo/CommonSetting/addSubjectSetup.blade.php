    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 md:my-10">
        ...
        <form id="dataForm" method="POST" action="{{ route('store.subject.setup') }}">
            ...
            <div>
                <div>
                    <div
                        class="grid gap-6 mb-6 py-5 md:grid-cols-3 items-center ps-4 border border-gray-200 rounded dark:border-gray-700 mx-20">
                        ...
                        @foreach ($subjectData as $data)
                            <div>
                                ...
                                <input id="subject_name" type="checkbox" value="{{ $data->subject_name }}"
                                    name="subject_name[]"
                                ...
                                <label for="subject_name"
                                    class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $data->subject_name }}</label>
                            </div>
                        @endforeach
                    ...
                    @if ($classWiseSubjectData !== null)
                        @foreach ($classWiseSubjectData as $key => $data)
                            <tr class=" border-b capitalize text-lg">
                                ...
                                <td class="px-6 py-4">
                                    {{ $data->subject_name }}
                                    <input class="hidden" value="{{ $data->id }}" type="text" name="id[]"
                                        id="">
                                    <input class="hidden" value="{{ $data->class_name }}" type="text" name="class_name"
                                        id="">
                                    <input class="hidden" value="{{ $data->group_name }}" type="text" name="group_name"
                                        id="">
                                </td>
