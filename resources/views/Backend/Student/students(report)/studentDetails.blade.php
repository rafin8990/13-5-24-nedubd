        ...
        <div class="md:mx-52 border-2 p-10 bg-blue-950">
            ...
            <form action="" method="" enctype="multipart/form-data">
                ...
                <div class=" flex justify-end">
                    <button type="submit"
                        class="text-white bg-rose-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Print</button>
                </div>
            </form>
        </div>
    </div>
