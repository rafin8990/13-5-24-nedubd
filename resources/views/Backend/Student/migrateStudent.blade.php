    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 md:my-10">
        ...
        <form action="">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-5 mt-20 mx-20">
                ...
                <div>
                    <select id="" name="migrate_section:"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <button type="button"
                class="  text-white bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-3 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Get Data
            </button>
        ...
        <div class="grid md:grid-cols-3 sticky z-56 md:mt-32 mb-5">
            ...
            <div class="mr-10">
                <a href="">
                <button type="button"
                    class="text-white  bg-rose-400 hover:bg-rose-400 focus:ring-4 focus:outline-none focus:ring-rose-300 font-medium rounded-lg text-sm w-full sm:w-auto px-20 py-2.5 text-center dark:bg-rose-300 dark:hover:bg-rose-400 dark:focus:ring-rose-400">Close</button>
                </a>
            </div>
