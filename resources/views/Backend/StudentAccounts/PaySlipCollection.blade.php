        ...
        <div class="bg-gray-200 col-span-2 p-5">
            <div class="flex justify-between">
                <div class="w-80">
                    ...
                    <div class="">
                        <label for="student_class" class="mb-2 text-sm font-medium text-gray-900 ">Voucher Number:</label>
                        <input type="text" value="" name="student_class" id="student_class"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-full"
                            placeholder="student class" />
                    </div>
                    ...
                    <div class="">
                        <label for="student_class" class="mb-2 text-sm font-medium text-gray-900 ">Collection
                            Amount:</label>
                        <input type="text" value="" name="student_class" id="student_class"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-full"
                            placeholder="student class" />
                ...
                <div class="w-80">
                    ...
                    <div class="">
                        <label for="mobile" class="mb-2 text-sm font-medium text-gray-900 ">Mobile:</label>
                    ...
                    <div class="">
                        <label for="village" class="mb-2 text-sm font-medium text-gray-900 ">Village:</label>
            ...
            <div class="mt-10">
                ...
                <div class="grid grid-cols-4 gap-5">
                    <div class="mt-20 flex flex-wrap gap-5 col-span-3">
                        ...
                        <div class="">
                            <label for="s_waiver" class="mb-2 text-sm font-medium text-gray-900 ">S. Waiver:</label>
                            <input type="text" value="" name="s_waiver" id="s_waiver"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-full"
                                placeholder="" readonly />
                        </div>
                        <div class="">
                        ...
                        <div class="">
                            <label for="changed" class="mb-2 text-sm font-medium text-gray-900 ">Changed:</label>
                            <input type="text" readonly value="" name="changed" id="changed"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-full"
                                placeholder="" />
                            <div class="flex items-center">
                                <input id="non_masking" name="non_masking" type="checkbox" value=""
                                    class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500  focus:ring-2 dark:bg-gray-700">
                                <label for="non_masking" class="ml-1 text-sm font-medium text-gray-900 ">
                                    Non-Masking</label>
                            </div>
                        </div>
                        <div class="mt-5">
                            <input type="text" value="" name="changed" id="changed"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-full"
                                placeholder="" />
                            <div class="flex items-center">
                                <input id="masking" name="masking" type="checkbox" value=""
                                    class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500  focus:ring-2 dark:bg-gray-700">
                                <label for="masking" class="ml-1 text-sm font-medium text-gray-900 ">
                                    Masking</label>
                            </div>
                        </div>
                    </div>
                    <div class="mt-24 space-y-3">
                        <div class="flex gap-2">
                            <label for="t_amount" class="mb-2 text-sm font-medium text-gray-900 ">Fine:</label>
                            <input type="text" value="" name="t_amount" id="t_amount"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-full"
                                placeholder="" readonly />
                            <input type="text" value="" name="t_amount" id="t_amount"
                        ...
                        <div class="flex gap-2">
                            <label for="t_amount" class="mb-2 text-sm font-medium text-gray-900 ">Fail:</label>
                            <input type="text" value="" name="t_amount" id="t_amount"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-full"
                                placeholder="" readonly />
                            <input type="text" value="" name="t_amount" id="t_amount"
                        ...
                        <div class="flex gap-2">
                            <label for="t_amount" class="mb-2 text-sm font-medium text-gray-900 ">Absent:</label>
                            <input type="text" value="" name="t_amount" id="t_amount"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-full"
                                placeholder="" readonly />
                            <input type="text" value="" name="t_amount" id="t_amount"
