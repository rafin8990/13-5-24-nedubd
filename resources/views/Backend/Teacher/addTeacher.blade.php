...
<div class="mx-10 mt-10">
    ...
    <form action="{{route('teacher.create')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border border-4">
            ...
            <div>
                <label for="emg_mobile" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Emergency
                    Mobile</label>
            ...
            <div>
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email Id
            ...
            <div>
                <label for="fbid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">FB ID
            ...
            <div>
                <label for="index" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Index
                </label>
            ...
            <div>
                <label for="salary_account" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Salary
                    Account No
                </label>
            ...
            <div>
                <label for="pf" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">PF Account No
                </label>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border border-4">
            ...
            <div>
                <label for="mother_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mother's
                    Name</label>
            ...
            <div>
                <label for="mother_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mother's
                    Number
                </label>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border border-4">
            ...
            <div>
                <label for="nationality"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nationality
                </label>
            ...
            <div>
                <label for="nid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NID
                </label>
            ...
            <div>
                <label for="marital_status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Marital
                    Status
                </label>
            ...
            <div>
                <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Joining
                    Date</label>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border border-4">
            <div>
                <label for="present_village"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Present
                    Village</label>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border border-4">
            <div>
                <label for="parmanent_village"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Parmanent
                    Village</label>
        ...
        <div class="grid gap-4 mb-6 md:grid-cols-7 p-5 border border-4">
            ...
            <div>
                <label for="ssc_roll" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Roll No
            ...
            <div>
                <label for="ssc_reg" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Registration
                    No
            ...
            <div>
                <label for="ssc_gpa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">GPA
            ...
            <div>
                <label for="ssc_year" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Passing Year
            ...
            <div>
                <label for="college_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    College Name
            ...
            <div>
                <label for="college_roll" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Roll No
            ...
            <div>
                <label for="college_gpa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">GPA
            ...
            <div>
                <label for="college_passing_year"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Passing Year
            ...
            <div>
                <label for="versity_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    University Name
            ...
            <div>
                <label for="versity_roll" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Roll No
            ...
            <div>
                <label for="versity_gpa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CGPA
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-3 p-5 border border-4">
            ...
            <div>
                <label for="qua_industry_name"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Industry Name
                </label>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border border-4 ">
            <div>
                <label for="post_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Post Name
                </label>
            ...
            <div>
                <label for="start_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Date
                </label>
            ...
            <div>
                <label for="end_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">End Date
                </label>
            ...
            <div class="hidden">
                <label for="school_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">End Date
                </label>
            ...
            <div class="hidden">
                <label for="role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">End Date
                </label>
            ...
            <div class="hidden">
                <label for="action" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">End Date
                </label>
