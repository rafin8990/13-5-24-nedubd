...
@include('Message.message')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 md:my-10">
        <div class="grid gap-6 mb-6 md:grid-cols-4 ">
            <button type="button"
                class=" md:mr-20 text-white bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><a
        ...
        <div class="p-4 md:p-5">
            ...
            <form class="space-y-4" action="{{ route('store.instructionInsert',$school_code) }}" method="POST"
                ...
                @csrf
                <div>
                    <label for="Code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Exam
                        Instruction:
                    </label>
